...
public class UserDao {
	...
	public ArrayList<BbsVO> outList(Connection conn) throws SQLException{
		ArrayList<BbsVO> outList= new ArrayList<BbsVO>();
		StringBuffer query  =new StringBuffer();
		...
		query.append(" START WITH bbs_no = 1");

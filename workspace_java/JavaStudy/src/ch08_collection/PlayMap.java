...
public class PlayMap {
	...
	public static void main(String[] args) {
		ArrayList<String> playList = new ArrayList<String>(
			...
			HashMap<String, ArrayList<String>> singerMap = new HashMap<String, ArrayList<String>>();
			...
			System.out.println("==============================================================================================================================================================================================================================");
			Set<String> keySet1 = singerMap.keySet();
			ArrayList<String> singer1 = new ArrayList<String>();
			for(String key: keySet1) {
				singer1.add(key);
			}
			Collections.sort(singer1);
			System.out.println(singer1);
			System.out.println("==============================================================================================================================================================================================================================");
			
			Scanner scanner = new Scanner(System.in);
			while(true) {
				System.out.print("가수이름을 입력해주세요:");
				String singname = scanner.nextLine();
				if(singname.equals("q")) {
					break;
				}
				System.out.println(makeSongList(singname,playList));

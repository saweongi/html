...
public class CollectionList {
	...
	public static void main(String[] args) {	
		...
		// .remove(값) 해당값이 없으면 삭제 없으면 아무일 안일어남.
		students.remove("홍길동");
		System.out.println(students);
		// .clear() 리스트 비움 (size 0됨)
		students.clear();
		System.out.println(students);
		intList = new ArrayList<>(); // clear()처럼 비어짐
		System.out.println("\n=================");

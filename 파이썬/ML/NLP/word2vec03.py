...
word2vec_model = word2vec.Word2Vec(data, vector_size=200, window=8, min_count=2, sg=1) #무조건 출현하는 단어
fasttext_model = fasttext.FastText(data, vector_size=200, window=8, min_count=2, sg=1) #합성어 머 이런것들 섞인것들
